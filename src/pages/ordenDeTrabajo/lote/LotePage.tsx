...
export const LotePage: React.FC<IComponentsRoute> = (
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      setPeriodo(periodo);
      const establecimientos = await getEstablecimientosByPeriodo();
      ...
      setLoading(false);
      ordenContext.ordenDeTrabajo.codPeriodo = periodo.codigo;
    };
    getData();
  }, []);
                ...
                <IonRow>
                  <IonCol>
                    <SearchableSelect
                      ...
                      handleBlur={() =>
                        formik.setFieldTouched("codEstablecimiento")
                      }
                      onChange={(e: any) =>
                        formik.setFieldValue("codEstablecimiento", e)
                      }
                    ></SearchableSelect>
                  </IonCol>
                </IonRow>
                  ...
                  <IonRow>
                    <IonCol>
                      <SearchableSelect
                        ...
                        handleBlur={() =>
                          formik.setFieldTouched("codContratista")
                        }
                        onChange={(e: any) =>
                          formik.setFieldValue("codContratista", e)
                        }
                      ></SearchableSelect>
                    </IonCol>
                  </IonRow>

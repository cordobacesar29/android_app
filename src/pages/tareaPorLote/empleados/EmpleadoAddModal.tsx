...
export const EmpleadoAddModal: React.FC<IPropsModal> = (props: IPropsModal) => {
  ...
  useEffect(() => {
    if (!props.isNew) {
      const emp: IEmpleadoModel = tarea.getEmpleado(id);
      setEmpleado(emp);
    }
  }, [props.isNew]);
  ...
  const formik = useFormik<IEmpleadoModel>({
    ...
    onSubmit: async (values: IEmpleadoModel) => {
      if (props.isNew) {
        ...
        tarea.addEmpleado(values);
        formik.resetForm();
      } else {
        // EDICION
        values.id = id;
        tarea.editEmpleado(values);
      }
    },
  });
          ...
          <IonHeader translucent>
            <IonToolbar>
              <IonTitle color="primary">
                {props.isNew ? "Cargar Empleado" : "Editar Empleado"}
              </IonTitle>
              <IonButtons slot="end">
            ...
            <form autoComplete="off" onSubmit={formik.handleSubmit}>
              ...
              <IonRow>
                <IonCol>
                  <Input
                    ...
                    onKeyPress={(e: any) => {}}
                    handleBlur={formik.handleBlur("legajo")}
                    onChange={(e: any) =>
                ...
                <IonCol>
                  <Input
                    ...
                    disabled={true}
                    isRequired={false}
                    value={formik.values.codEmpleado}
                    type="text"
                    placeholder="Código"
                    onKeyPress={(e: any) => {}}
                    handleBlur={() => {}}
              ...
              <IonRow>
                <IonCol>
                  <Select
                    isRequired={true}
                    label="Concepto"
                    value={formik.values.codConcepto}
                    ...
                    handleBlur={formik.handleBlur("codConcepto")}
                    onChange={(e: any) =>
                      formik.setFieldValue("codConcepto", e.detail.value)
                    }
                  ></Select>
                </IonCol>
              </IonRow>
              ...
              <IonRow className="button-modal">
                <IonCol>
                  ...
                  >
                    {props.isNew ? "Agregar Empleado" : "Guardar Empleado"}
                  </IonButton>
                </IonCol>
              </IonRow>
            </form>
